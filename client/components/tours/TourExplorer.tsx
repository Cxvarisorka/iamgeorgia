      ...
      <Container>
        <div className="border-b border-line pb-8">
          <SearchField
            ...
            tone="dark"
            label="Search tours"
            placeholder="Search by name, region or interest"
            className="max-w-xl"
          />

          <div className="mt-8 flex flex-col gap-5">
            <div className="flex flex-wrap items-center gap-2">
              <span className="type-caption mr-1 w-16 shrink-0 text-muted">Type</span>
              ...
              {tourCategories.map((item) => (
                <FilterChip
                  ...
                  onClick={() => setCategory(category === item.value ? null : item.value)}
                >
                  {item.label}
                </FilterChip>
              ))}
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="type-caption mr-1 w-16 shrink-0 text-muted">Length</span>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 py-6">
          <p className="type-body-sm text-muted">
            <span className="font-medium text-ink">{pluralize(results.length, "journey")}</span>
        ...
        {results.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Try widening the length or region — or tell us what you had in mind and we will build it."
            onReset={reset}
            action={{ label: "Plan a custom trip", href: "/contact" }}
          />
        )}
      </Container>
    </section>
