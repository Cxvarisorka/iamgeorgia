/**
 * Georgian, Russian and Hebrew copy for the transfer points, keyed by the
 * prototype's location ids, which `scripts/seed-transfer-translations.js`
 * maps onto catalogue point slugs.
 *
 * Real work by a translator. It lived in `client/data/i18n/transferLocations.ts`
 * until the catalogue moved into Postgres; it now lives beside the seed that
 * loads it.
 */
/**
 ...
 */
export const transferLocationContent = {
  ka: {
    "tbs-airport": {
